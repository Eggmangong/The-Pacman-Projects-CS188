...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        for ghostPos in livingGhostPositionDistributions:
            likelyPos = [ghostPos.argMax()]
        closest = min(likelyPos, key=lambda pos: self.distancer.getDistance(pacmanPosition, pos))
        bestAction = min(legal, key=lambda action: self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, action), closest))
